...
public class CobblemonCustomBiomes implements ModInitializer {
    ...
    public void onInitialize() {
        registerBiomes();
        registerCommands();
        System.out.println("CobblemonCustomBiomes cargado correctamente!");
    }

    private void registerBiomes() {
        // Los 100 biomas se registrarán mediante archivos JSON (datapack)
            ...
            dispatcher.register(literal("cobblemonbiome")
                ...
                .then(literal("add")
                    ...
                    .executes(ctx -> {
                        ...
                        source.sendFeedback(() -> Text.literal("§aSpawn de " + pokemon + " registrado en " + biome), true);
                        return 1;
                    }))))))))));
        });
    }
